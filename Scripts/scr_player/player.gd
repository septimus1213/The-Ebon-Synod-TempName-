...
var debug_draw_hitbox = false  # set to true to show hitbox
...
# Weapon system - ALWAYS HAVE BOTH
...
func handle_weapon_switch():
	if Input.is_action_just_pressed("btn_sword"):  # Q key
		current_weapon = Weapon.SWORD
		update_weapon_visuals()
		print("Switched to SWORD")
	elif Input.is_action_just_pressed("btn_bow"):  # E key
		current_weapon = Weapon.BOW
		update_weapon_visuals()
		print("Switched to BOW")

func update_weapon_visuals():
	print("Updating visuals for weapon: ", current_weapon)
	print("Weaponicons node exists: ", weaponicons != null)
	match current_weapon:
		Weapon.SWORD:
			weapon_sprite.visible = true
			crossbow.visible = false
			weaponicons.visible = true
			weaponicons.animation = "sword"
		Weapon.BOW:
			weapon_sprite.visible = false
			crossbow.visible = true
			weaponicons.visible = true
			weaponicons.animation = "crossbow"
